...
if __name__ == "__main__":
    ...
    assert day14_part1(example_input, 10) == 26
    print(day14_part1(test_input, 2000000))

    assert day14_part2(example_input, 20) == 56000011
    print(day14_part2(test_input, 4000000))